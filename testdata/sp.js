...
(function e(b, g, d) {
        ...
        (function (d) {
            var f = (function () {
                var h = "s", i = function (q) {
                    ...
                    var s = r.getMonth() > 7, v = s ? n(r.getFullYear()) : j(r.getFullYear()), q = i(r), u = v < 0,
                        t = v - q;
                    if (!u && !s) {
                        return t < 0
                    }
                    ...
                    var r = new Date(2010, 6, 15, 1, 0, 0, 0), s = {
            ...
            f.TimeZone = function (g) {
                var h = {
                    ...
                    var m = h[i], o = m.length, n = 0, p = m[0];
                    for (; n < o; n += 1) {
                        p = m[n];
    ...
    6: [function (b, c, a) {
        (function () {
            var d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", f = {
                rotl: function (h, g) {
                    return (h << g) | (h >>> (32 - g))
                }, rotr: function (h, g) {
                    return (h << (32 - g)) | (h >>> g)
    ...
    7: [function (b, c, a) {
        (function () {
            var h = b("crypt"), d = b("charenc").utf8, f = b("charenc").bin, i = function (r) {
                if (r.constructor == String) {
                    r = d.stringToBytes(r)
                }
                var z = h.bytesToWords(r), A = r.length * 8, s = [], v = 1732584193, u = -271733879, q = -1732584194,
                    p = 271733878, o = -1009589776;
                z[A >> 5] |= 128 << (24 - A % 32);
                z[((A + 64 >>> 9) << 4) + 15] = A;
                for (var C = 0; C < z.length; C += 16) {
                    var H = v, G = u, F = q, E = p, D = o;
                    for (var B = 0; B < 80; B++) {
                        if (B < 16) {
                            s[B] = z[C + B]
                        } else {
        ...
        function f(j, p) {
            ...
            return {
                setBase64Encoding: function (q) {
                    j = q
                }, addPayloadPair: m, addPayloadDict: function (r) {
                    for (var q in r) {
                    ...
                    m("ip", q)
                }, trackUnstructEvent: o, trackPageView: function (u, t, s, r, q) {
    ...
    11: [function (b, c, a) {
        (function () {
            var h = b("JSON"), d = b("./base64"), g = typeof a !== "undefined" ? a : this;
            ...
            g.payloadBuilder = function (j) {
                ...
                return {
                    add: m, addDict: i, addJson: l, build: function () {
                        return n
                    }
                }
            }
    ...
    17: [function (c, d, a) {
        var g = c("./lib_managed/lodash"), f = c("./lib/helpers"), b = typeof a !== "undefined" ? a : this;
    ...
    18: [function (b, c, a) {
        (function () {
            var h = b("./lib_managed/lodash"), g = b("./lib/helpers"), f = b("uuid"),
            ...
            d.InQueueManager = function (j, r, q, n, s) {
                ...
                function w(z) {
                    var y = z.split(":"), i = y[0], x = (y.length > 1) ? y[1].split(";") : [];
                    return [i, x]
                }
    ...
    20: [function (b, c, a) {
        (function () {
            var n = b("../lib_managed/lodash"), m = b("murmurhash").v3, h = b("jstimezonedetect").jstz.determine(),
                f = b("browser-cookie-lite"), i = typeof a !== "undefined" ? a : this, l = window, d = navigator,
                j = screen, g = document;
            ...
            i.detectDocumentSize = function () {
                var s = g.documentElement, q = g.body, r = q ? Math.max(q.offsetHeight, q.scrollHeight) : 0;
    ...
    }, {"../lib_managed/lodash": 23, "browser-cookie-lite": 2, jstimezonedetect: 3, murmurhash: 4}],
    21: [function (b, c, a) {
        (function () {
            var g = b("../lib_managed/lodash"), d = typeof a !== "undefined" ? a : this;
            ...
            d.getHostName = function (h) {
                var j = new RegExp("^(?:(?:https?|ftp):)/*(?:[^@]+@)?([^:/#]+)"), i = j.exec(h);
                return i ? i[1] : h
            };
    ...
    22: [function (b, c, a) {
        (function () {
            var g = b("./helpers"), d = typeof a !== "undefined" ? a : this;
            ...
            function h(m, l) {
                var o = new RegExp("^(?:https?|ftp)(?::/*(?:[^?]+))([?][^#]+)"), n = o.exec(m),
    ...
    23: [function (b, c, a) {
        (function (d) {
            (function () {
                ...
                var j = "[object Arguments]", H = "[object Array]", an = "[object Boolean]", r = "[object Date]",
                    aL = "[object Error]", u = "[object Function]", at = "[object Number]", av = "[object Object]",
                    ay = "[object RegExp]", R = "[object String]";
                var W = {};
                W[u] = false;
                ...
                function z(aY, aX, aU) {
                    ...
                    var aV = -1, aW = aU - aX || 0, aT = Array(aW < 0 ? 0 : aW);
                    while (++aV < aW) {
                        aT[aV] = aY[aX + aV]
                    }
                    return aT
                ...
                var n = [];
                var l = Error.prototype, aF = Object.prototype, Z = String.prototype;
                var al = aF.toString;
                var q = RegExp("^" + String(al).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/toString| for [^\]]+/g, ".*?") + "$");
                var y = Function.prototype.toString, ad = aF.hasOwnProperty, i = n.push, ac = aF.propertyIsEnumerable,
                    aH = n.unshift;
                var w = (function () {
                    try {
                        var aW = {}, aU = O(aU = Object.defineProperty) && aU, aT = aU(aW, aW, aW) && aU
                    } catch (aV) {
                    }
                    return aT
                }());
                var P = O(P = Object.create) && P, t = O(t = Array.isArray) && t, aO = O(aO = Object.keys) && aO;
                var ae = {};
                ae[H] = Array;
                ae[an] = Boolean;
                ae[r] = Date;
                ...
                function G(aX) {
                    ...
                    function aV() {
                        ...
                        if (this instanceof aV) {
                            var aZ = s(aW.prototype), aY = aW.apply(aZ, a0 || arguments);
                            return E(aY) ? aY : aZ
                        }
                ...
                function Q(aW) {
                    var aY = aW[0], aV = aW[1], a0 = aW[2], aU = aW[3], a3 = aW[4], aT = aW[5];
                    var aX = aV & 1, a5 = aV & 2, a2 = aV & 4, a1 = aV & 8, a4 = aY;
                ...
                function aB(bb, ba, a0, a7, bd, bc) {
                    ...
                    var aU = al.call(bb), a3 = al.call(ba);
                    if (aU == j) {
                        aU = av
                    }
                    if (a3 == j) {
                    ...
                    var a1 = aU == H;
                    if (!a1) {
                        var a6 = ad.call(bb, "__wrapped__"), aT = ad.call(ba, "__wrapped__");
                        if (a6 || aT) {
                ...
                function F(aZ, aW, a0, aV, a5, aT) {
                    var aY = aW & 1, a6 = aW & 2, a3 = aW & 4, a2 = aW & 8, aU = aW & 16, a1 = aW & 32;
                    if (!a6 && !aA(aZ)) {
                        throw new TypeError
                    }
                    if (aU && !a0.length) {
                ...
                function p(aW) {
                    ...
                    var aU = al.call(aW), aV = aW.length;
                ...
                function x(aX, aY, aU) {
                    var aV = -1, aW = aX ? aX.length : 0, aT = Array(typeof aW == "number" ? aW : 0);
        ...
        b.getLinkTrackingManager = function (p, j, s) {
            ...
            function u(x, w) {
                ...
                if (!g.isUndefined(x.href)) {
                    var A = x.hostname || f.getHostName(x.href), y = A.toLowerCase(), v = x.href.replace(A, y),
    ...
    25: [function (b, c, a) {
        (function () {
            var g = b("JSON"), i = b("./lib_managed/lodash"), f = b("./lib/detectors").localStorageAccessible,
                h = b("./lib/helpers"), d = typeof a !== "undefined" ? a : this;
            d.OutQueueManager = function (z, s, u, B, y, o, m) {
                ...
                function q(J) {
                    var F = "?", G = {co: true, cx: true}, E = true;
                    for (var I in J) {
    ...
    }, {"./lib/detectors": 20, "./lib/helpers": 21, "./lib_managed/lodash": 23, JSON: 1}],
    26: [function (b, c, a) {
        (function () {
            var i = b("./lib_managed/lodash"), h = b("./lib/helpers"), d = b("./in_queue"), g = b("./tracker"),
                f = typeof a !== "undefined" ? a : this;
            f.Snowplow = function (m, r) {
                var l = document, n = window, p = "js-2.5.1", o = {
                    outQueues: [],
                    bufferFlushers: [],
                    expireDateTime: null,
                    hasLoaded: false,
                ...
                function s() {
                    ...
                    if (!o.hasLoaded) {
                        o.hasLoaded = true;
                        for (t = 0;
                             t < o.registeredOnLoadHandlers.length; t++) {
    ...
    }, {"./in_queue": 18, "./lib/helpers": 21, "./lib_managed/lodash": 23, "./tracker": 27}],
    27: [function (b, c, a) {
        (function () {
            var s = b("./lib_managed/lodash"), g = b("./lib/helpers"), j = b("./lib/proxies"),
                h = b("browser-cookie-lite"), q = b("./lib/detectors"), l = b("JSON"), p = b("sha1"), r = b("./links"),
                f = b("./forms"), n = b("./out_queue"), o = b("snowplow-tracker-core"), d = b("uuid"),
                i = typeof a !== "undefined" ? a : this;
            i.Tracker = function m(bb, aK, Q, a2, B, av) {
                var z = o(true, function (bh) {
                        L(bh);
                        ae(bh, aD)
                    }), am = document, ac = window, S = navigator,
                    v = j.fixupUrl(am.domain, ac.location.href, g.getReferrer()), aT = g.fixupDomain(v[0]), ba = v[1],
                    aG = v[2], af, av = av || {}, aE = "GET", J = av.hasOwnProperty("platform") ? av.platform : "web",
                    x, aW = av.hasOwnProperty("appId") ? av.appId : "", aq, aI = am.title, C,
                    aD = av.hasOwnProperty("pageUnloadTimer") ? av.pageUnloadTimer : 500, E, R, F,
                    a7 = av.hasOwnProperty("cookieName") ? av.cookieName : "_sp_",
                    H = av.hasOwnProperty("cookieDomain") ? av.cookieDomain : null, a8 = "/",
                    X = S.doNotTrack || S.msDoNotTrack,
                    a0 = av.hasOwnProperty("respectDoNotTrack") ? av.respectDoNotTrack && (X === "yes" || X === "1") : false,
                    ai, K = 63072000, O = av.hasOwnProperty("sessionCookieTimeout") ? av.sessionCookieTimeout : 1800,
                    T = av.hasOwnProperty("userFingerprintSeed") ? av.userFingerprintSeed : 123412414,
                    aY = am.characterSet || am.charset,
                    aL = av.hasOwnProperty("forceSecureTracker") ? (av.forceSecureTracker === true) : false,
                    ah = av.hasOwnProperty("useLocalStorage") ? av.useLocalStorage : true,
                    ax = av.hasOwnProperty("useCookies") ? av.useCookies : true, I = S.userLanguage || S.language,
                    aX = q.detectBrowserFeatures(ax, N("testcookie")),
                    y = (av.userFingerprint === false) ? "" : q.detectSignature(T), M = bb + "_" + aK, aH = false, aF,
                    a6 = new Date().getTime(), aB, ar, an, Z, ab = p, aJ, aj, W, V = 1, bg, D = aQ(),
                    u = r.getLinkTrackingManager(z, M, a4), ao = f.getFormTrackingManager(z, M, a4),
                    a3 = new n.OutQueueManager(bb, aK, B, ah, av.post, av.bufferSize, av.maxPostBytes || 40000),
                    aP = false, bc = av.contexts || {}, bd = [];
                if (bc.webPage) {
                    bd.push(aV())
                }
                if (bc.gaCookies) {
                ...
                function be(bh) {
                    var bj = new RegExp("^([a-z]+):"), bi = bj.exec(bh);
                    return bi ? bi[1] : null
                }
                ...
                function L(bo) {
                    var bj = Math.round(new Date().getTime() / 1000), bm = N("id"), bl = N("ses"), bq = ag("ses"),
                        bi = aO(), br = bi[0], bp = bi[1], bt = bi[2], bk = bi[3], bs = bi[4], bh = bi[5], bn = bi[6];
                    if (a0 && ax) {
                        h.cookie(bm, "", -1, a8, H);
                        h.cookie(bl, "", -1, a8, H);
                        return
                ...
                function aV() {
                    return {schema: "iglu:com.snowplowanalytics.snowplow/web_page/jsonschema/1-0-0", data: {id: a2}}
                }
                ...
                function P() {
                    ...
                    if (bj) {
                        ...
                        return {schema: "iglu:org.w3/PerformanceTiming/jsonschema/1-0-0", data: bi}
                    }
                }
                ...
                function G() {
                    ...
                    return {schema: "iglu:com.google.analytics/cookies/jsonschema/1-0-0", data: bh}
                }
                ...
                return {
                    getUserId: function () {
                        ...
                        a3.executeQueue()
                    }, enableGeolocationContext: a9, trackPageView: function (bj, bi, bh) {
                        Y(function () {
                            aw(bj, bi, bh)
                        })
                        ...
                        z.trackUnstructEvent({
                            ...
                            data: {category: bl, variable: bi, timing: bk, label: bh}
                        }, a4(bj))
                    }
                }
            }
